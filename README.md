...
RunningString. Занятия по C++. ИС Embarcadero Rad Studio. Строки. Консольное приложение. Расширенные возможности. Библиотека Conio. 
Программа делает следующее:
  ...
  10. Выгружает библиотеку PDCurses и завершает работу.
